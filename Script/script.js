...
var productName_pattern = /^[a-zA-Z]{3,8}$/
var price_pattern = /^[0-9]{1,3}$/
var category_pattern = /^mobile|laptop|tablet|TV$/
...
function validation(){
    ...
    if (category_pattern.test(productCategory.value) == false) {
        productCategory.nextElementSibling.innerHTML = `*Choose from mobile or laptop or tablet or TV`
        e3 = false
    } else {
